  ...
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 p-20 font-['Founders_Grotesk'] ">
      ...
      <div className="w-1/2">
        ...
        <h1 className="text-2xl mt-16 font-thin">S:</h1>
        <div className="dets font-['Neue_Montreal'] mt-16 ">
          {["Facebook", "Instagram", "Twitter","Behance"].map((item, index) => {
            return <a className="block text-xl font-light" key={index}>{item}</a>;
          })}
        </div>
      </div>
    </div>
